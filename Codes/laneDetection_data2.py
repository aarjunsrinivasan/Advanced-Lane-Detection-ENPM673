# -*- coding: utf-8 -*-
"""
Created on Wed Mar 11 12:24:53 2020
...
if __name__ == '__main__':
    cap = cv2.VideoCapture("C:\\Users\\Praveen\\ENPM673_Project_2\\data_2\\challenge_video.mp4")
    fourcc = cv2.VideoWriter_fourcc(*'MP4V')
    out = cv2.VideoWriter('data2_output.mp4', fourcc, 30, (1280, 720))
    while(cap.isOpened()):
        ret, frame = cap.read()
        if ret == False:
            break
